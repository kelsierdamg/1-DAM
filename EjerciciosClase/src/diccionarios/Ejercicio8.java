	...
	public static void main(String[] args) {
		...
		while(continuar) {
			System.out.println("""
					...
					7. Sacar un listado de las personas y sus DNI
					8. Borrarlo todo
					9. Salir
					""");
			...
			case 1:
				...
				if (dni.size()<13) {
				    ...
				    System.out.println("No se pueden almacenar más de 13 nombres.");
				}
				break;
			case 2:
			...
			case 6:
				...
				break;
			case 7:
				System.out.println(dni.entrySet());
			case 8:
				System.out.println("¿Está seguro de que quiere borrar todo el diccionario?(s/n)");
				String sn = entrada.next();
				
				if(sn.equalsIgnoreCase("s")) {
					dni.clear();
					System.out.println("Se ha borrado todo el diccionario");
				}
				else {
					break;
				}
